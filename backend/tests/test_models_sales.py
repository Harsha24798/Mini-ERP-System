...
class TestSalesOrderModel:
    ...
    def test_create_sales_order(self, db_session):
        ...
        customer = Customer(
            customer_code="CUST-001", name="Customer One", email="c1@test.com"
        )
    ...
    def test_sales_order_calculate_totals(self, db_session):
        ...
        customer = Customer(
            customer_code="CUST-002", name="Customer Two", email="c2@test.com"
        )
        ...
        product1 = Product(
            sku="P1", name="Product 1", category_id=category.id, price=Decimal("10.00")
        )
        product2 = Product(
            sku="P2", name="Product 2", category_id=category.id, price=Decimal("20.00")
        )
...
class TestSalesOrderItemModel:
    ...
    def test_calculate_line_total(self, db_session):
        ...
        customer = Customer(
            customer_code="CUST-003", name="Customer Three", email="c3@test.com"
        )
...
class TestInvoiceModel:
    ...
    def test_create_invoice(self, db_session):
        ...
        customer = Customer(
            customer_code="CUST-004", name="Customer Four", email="c4@test.com"
        )
        db_session.add(customer)
        db_session.commit()
    ...
    def test_invoice_update_balance(self, db_session):
        ...
        customer = Customer(
            customer_code="CUST-005", name="Customer Five", email="c5@test.com"
        )
        user = User(
            username="payuser", email="pay@test.com", first_name="Pay", last_name="User"
        )
        user.set_password("password")
