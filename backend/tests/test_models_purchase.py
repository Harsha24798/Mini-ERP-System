...
class TestPurchaseOrderModel:
    ...
    def test_create_purchase_order(self, db_session):
        ...
        supplier = Supplier(
            supplier_code="SUP-001", name="Supplier One", email="s1@test.com"
        )
    ...
    def test_purchase_order_calculate_totals(self, db_session):
        ...
        supplier = Supplier(
            supplier_code="SUP-002", name="Supplier Two", email="s2@test.com"
        )
...
class TestPurchaseOrderItemModel:
    ...
    def test_calculate_line_total(self, db_session):
        ...
        supplier = Supplier(
            supplier_code="SUP-003", name="Supplier Three", email="s3@test.com"
        )
    ...
    def test_track_received_quantity(self, db_session):
        ...
        supplier = Supplier(
            supplier_code="SUP-004", name="Supplier Four", email="s4@test.com"
        )
...
class TestBillModel:
    ...
    def test_create_bill(self, db_session):
        ...
        supplier = Supplier(
            supplier_code="SUP-005", name="Supplier Five", email="s5@test.com"
        )
        db_session.add(supplier)
        db_session.commit()
    ...
    def test_bill_update_balance(self, db_session):
        ...
        supplier = Supplier(
            supplier_code="SUP-006", name="Supplier Six", email="s6@test.com"
        )
        db_session.add(supplier)
        db_session.commit()
